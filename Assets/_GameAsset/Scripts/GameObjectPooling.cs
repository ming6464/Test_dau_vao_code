...
public class GameObjectPooling : Singleton<GameObjectPooling>
{
    [Serializable]
    ...
    private Dictionary<PoolKEY, ObjectPool> m_gameObjectsDic = new Dictionary<PoolKEY, ObjectPool>();
    ...
    {
        public List<Transform> gameObjectsTf = new List<Transform>();
